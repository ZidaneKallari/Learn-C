...
void hapus_data_user_dari_file(const char *username)
{
    ...
    {
        // Menyimpan setiap baris yang bukan milik username yang ingin dihapus
    ...
    // Menghapus file asli dan mengganti dengan file temp_file.txt
...
void buat_forum()
{
    ...
    // Menyimpan data forum ke dalam file
...
void lihat_forum()
{
    ...
    // Membaca dan menampilkan data forum dari file
    int i = 1;
    while (fgets(judul, sizeof(judul), file) != NULL)
    {
        judul[strcspn(judul, "\n")] = '\0'; // Menghapus karakter newline pada judul
...
void hapus_forum()
{
    ...
    // Menghapus data forum dari memori
    ...
    // Menghapus data forum dari file
    ...
    // Membaca data forum dari file dan menulis kembali ke file
    ...
    // Mengganti file data_forum.txt dengan temp_data_forum.txt
